      ...
      >
        ...
        >
          <div className="flex flex-col gap-8 md:gap-12 font-serif">
            ...
            >
              <p className="text-base md:text-lg leading-relaxed italic font-semibold text-justify">
            ...
            >
              ...
              <div className="text-center p-6 rounded-xl border-2 border-[#2E8C4F] bg-gray-800/30">
                ...
                <h3 className="text-base md:text-lg text-white leading-relaxed italic font-semibold">
                  <span className="font-semibold italic">Tầm nhìn:</span> INLANDV hướng đến vị thế dẫn đầu trong lĩnh vực Bất động sản, đặc biệt là bất động sản công nghiệp, đồng thời xây dựng hệ sinh thái bất động sản đột phá và bền vững.
                </h3>
              </div>
              ...
              <div className="text-center p-6 rounded-xl border-2 border-[#2E8C4F] bg-gray-800/30">
                ...
                <h3 className="text-base md:text-lg text-white leading-relaxed italic font-semibold">
                  <span className="font-semibold italic">Sứ mệnh:</span> INLANDV cam kết mang đến giải pháp bất động sản toàn diện, tối ưu chi phí – gia tăng giá trị đầu tư. Chúng tôi đồng hành cùng doanh nghiệp mở rộng kết nối toàn cầu, nâng cao vị thế trên thị trường quốc tế.
                </h3>
              </div>
              ...
              <div className="text-center p-6 rounded-xl border-2 border-[#2E8C4F] bg-gray-800/30">
                ...
                <h3 className="text-base md:text-lg text-white leading-relaxed italic font-semibold">
                  <span className="font-semibold italic">Giá trị cốt lõi:</span> Tận tâm - Chuyên<br />nghiệp - Minh bạch – Bền vững.
                </h3>
              </div>
            </motion.div>
          </div>
