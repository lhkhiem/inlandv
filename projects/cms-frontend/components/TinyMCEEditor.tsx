...
// Use CDN by default if no API key (community version)
const TINYMCE_SCRIPT_SRC =
  process.env.NEXT_PUBLIC_TINYMCE_SCRIPT_SRC?.trim() ||
  (TINYMCE_API_KEY 
    ? `https://cdn.tiny.cloud/1/${TINYMCE_API_KEY}/tinymce/7/tinymce.min.js` 
    : 'https://cdn.jsdelivr.net/npm/tinymce@7/tinymce.min.js'); // Use jsDelivr CDN as fallback
