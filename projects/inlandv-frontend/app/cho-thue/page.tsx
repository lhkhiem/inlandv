...
function ChoThuePageContent(){
  ...
  const [filters, setFilters] = useState<ProductFilters>({ q: initialQ, type: undefined, locationTypes: [], provinces: [], wards: [], price: [0, 10_000_000_000], area: [0, 100000] })

  return (
    <div className="min-h-screen bg-[#151313]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <h1 className="text-3xl font-bold text-white mb-6">Cho thuê</h1>
        <div className="space-y-6">
          ...
          />
          <ProductGrid filters={filters} transactionType="cho-thue" />
        </div>
      </div>
    </div>
  )
